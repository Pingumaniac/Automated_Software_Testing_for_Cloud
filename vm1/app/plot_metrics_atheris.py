...
plt.legend()
plt.grid(True)
plt.savefig('plots/insert_latency_atheris.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('plots/query_latency_atheris.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('plots/update_latency_atheris.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('plots/delete_latency_atheris.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('plots/throughput_atheris.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('plots/cpu_utilization_atheris.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('plots/memory_utilization_atheris.png')
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('plots/disk_io_atheris.png')
plt.close()
...
plt.savefig('plots/crash_rate_atheris.png')
plt.close()
