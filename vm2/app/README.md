...
## 6. Instructions to Execute the Software

### 6.1 Prerequisites

1. Follow [this](app/README.md) to set up everything.

### 6.2 Access the Kubernetes Pod
```
kubectl exec -it python-mongo-client -- /bin/bash
```

### 6.3 Run the Python codes inside the pod sequentially
```
python3 test.py
...
### 8. Additional Files and Directories
